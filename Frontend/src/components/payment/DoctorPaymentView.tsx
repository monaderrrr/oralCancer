      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500">
            Manage patient payments and view transaction history
          </p>
        </div>
      ...
      <Card className="p-4">
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search by patient or transaction ID..." className="pl-10" />
          </div>
                      ...
                      <div className="relative">
                        ...
                        {activeHelp === payment.id && <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-100 z-20 p-3">
                            ...
                            <div className="space-y-2">
                              <div className="flex items-start gap-2 text-xs text-gray-600 p-2 hover:bg-gray-50 rounded">
                                <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                                <div>
                                  <span className="font-medium text-gray-900">
                                    Confirm Receipt
                                  </span>
                                  <p>Mark manually if paid in cash/transfer.</p>
                                </div>
                              </div>
                              <div className="flex items-start gap-2 text-xs text-gray-600 p-2 hover:bg-gray-50 rounded">
                                ...
                                <div>
                                  ...
                                  <p>
                                    Initiate refund process for this
                                    transaction.
                                  </p>
                                </div>
                              </div>
