...
import API from '../../Api'; // Central API instance (handles auth token automatically)
...
export function RiskAssessmentPage() {
  ...
  /**
   * Save risk assessment inside existing backend system (no dedicated endpoint)
   * Using patient scans endpoint as fallback storage
   */
        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          <Card className="p-8 md:p-12 text-center border-slate-200">
            ...
            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
              This quick assessment helps us estimate your oral health risk level.
            </p>
            ...
            <div className="flex flex-col gap-3 max-w-xs mx-auto">
              ...
              <p className="text-xs text-slate-400 mt-2">
                Takes about 2 minutes • Confidential
              </p>
            </div>
          </Card>
        </div>
