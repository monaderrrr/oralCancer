        ...
        opacity: 1
            ...
            <Card className="p-8 text-center">
              ...
              <p className="text-slate-600 text-lg mb-8 max-w-lg mx-auto">
                This tool can help you understand your symptoms, but it does not
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8 text-left flex gap-3">
                ...
                <p className="text-sm text-amber-800">
                  If you are experiencing severe pain, heavy bleeding, or
        ...
        x: 0
            ...
            <Card className="p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {symptoms.map(symptom => <button key={symptom} onClick={() => toggleSymptom(symptom)} className={`
                      p-4 rounded-xl border-2 text-left transition-all flex justify-between items-center
                      ${selectedSymptoms.includes(symptom) ? 'border-teal-500 bg-teal-50 text-teal-900' : 'border-slate-200 hover:border-teal-300'}
                    `}>
            ...
            <Card className="p-8">
              ...
              <div className="bg-slate-50 rounded-xl p-6 mb-8">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {selectedSymptoms.map(s => <span key={s} className="px-3 py-1 bg-white border border-slate-200 rounded-full text-sm text-slate-600">
                      {s}
                    </span>)}
                </div>
                <p className="text-slate-600">
                  These symptoms may indicate early signs of oral health issues.
                  We recommend scheduling a consultation with a specialist for a
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Button fullWidth>Find a Doctor</Button>
              </div>
            </Card>
          </motion.div>}
      </div>
